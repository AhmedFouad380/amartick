...
var KTLogin = function () {
    ...
    var _handleFormForgot = function () {
        ...
        FormValidation
                ...
                form,
                {
                    fields: {
                        email: {
                            validators: {
                                notEmpty: {
                                    message: 'البريد الاليكترونى مطلوب'
                                },
                                emailAddress: {
                                    message: 'صيغه البريد الاليكترونى غير صحيحه'
                                }
                            }
                        }
                    },
            ...
            .on('core.form.invalid', function () {
                Swal.fire({
                    text: "نعتذر يبدو ان هناك بعض الاخطاء ف بياناتك برجاء المراجعه",
                    icon: "error",
                    buttonsStyling: false,
    ...
    var _handleFormSignup = function () {
            ...
            form,
            {
                fields: {
                    ...
                    attachments: {
                        validators: {
                            notEmpty: {
                                message: 'المرفقات مطلوبه (السجل التجاري ....)'
                            }
                        }
                    },
                },
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        Swal.fire({
                            text: "برجاء مراجعه البيانات مرة اخرى والتحقق من الاخطاء",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "حسنآ",
                            customClass: {
        ...
        wizardObj.on('submit', function (wizard) {
            Swal.fire({
                text: "يبدو كل البيانات جيدة تريد الارسال؟",
                icon: "success",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonText: "نعم ارسل !",
                cancelButtonText: "لأ ,انتظر",
                customClass: {
