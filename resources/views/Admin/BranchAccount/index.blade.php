                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.BranchAccount')}}</h5>
                            </li>
                        </ul>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.BranchAccount')}} : @inject('supplier','App\Models\Supplier')
                        {{$supplier->find($id)->name}}
                    </div>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_tdata">
                        ...
                        <tr>
                            <th>#</th>
                            <th class="headerr">{{__('lang.amount')}} </th>
                            <th class="headerr">{{__('lang.type')}} </th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form" method="post"
                          action="{{url('create-BranchAccount')}}" >
                        @csrf
                        <input type="hidden" name="project_id" value="{{$id}}">
                        <div class="form-group">
                            <label>{{__('lang.amount')}} </label>
                            <input type="number" class="form-control form-control-solid" name="amount" required placeholder="{{__('lang.amount')}}" >
                        </div>
