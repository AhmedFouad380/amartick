                ...
                <!--end::Svg Icon-->
                                ...
                                <div
                                    ...
                                    <div class="navi-item my-2">
                                        <a href="{{url("inbox")}}" class="navi-link active">
                                            ...
                                            {{--																<span--}}
                                            {{--                                                                    class="label label-rounded label-light-success font-weight-bolder">{{$Users->where("is_read",0)->count()}}</span>--}}
                                            {{--															</span>--}}
                                        </a>
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <!--begin::Item-->
                                    <div class="navi-item my-2">
                                        <a href="{{url("outbox")}}" class="navi-link">
															<span class="navi-icon mr-4">
																<span class="svg-icon svg-icon-lg">
                                        ...
                                        <div class="d-flex align-items-start card-spacer-x py-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap w-xxl-200px mr-3"
                                                     data-toggle="view" style="width: -webkit-fill-available;">
																<span class="symbol symbol-35 mr-3">
																	<span class="symbol-label"
                                                                          @if($user->getSender)style="background-image: url('{{$user->getSender->image}}')"@endif></span>
																</span>
                                                    <span
                                                        class="font-weight-bold text-dark-75 text-hover-primary"> @if($user->getSender) {{$user->getSender->name}}@endif  </span>
                                                </div>
                                                <!--end::Author-->
                                            </div>
                                            <!--end::Toolbar-->
...
@section('js')
    ...
    <script>
        ...
        function order_not_allowed() {
            Swal.fire("{{__('lang.Sorry')}}", "{{__('lang.order_not_allowed')}}", "error");
        }
