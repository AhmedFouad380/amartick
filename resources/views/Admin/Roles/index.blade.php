                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.roles')}}</h5>
                            </li>
                        </ul>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.roles')}}
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form" method="post"
                          action="{{url('roles/store')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless mb-0 ">
                                ...
                                @foreach(Spatie\Permission\Models\Permission::all() as $key=> $single)
                                    @if($key==0)
                                        <tr>
                                            <th style="font-size:large;color: #0e6662 "
                                                class=""> {{trans('lang.Settings')}}</th>
                                        </tr>
                                    @endif
                                    @if($key==7)
                                        <tr>
                                            <th style="font-size:large;color: #0e6662 "
                                                class=""> {{trans('lang.Other Setting')}}</th>
                                        </tr>
                                    @endif
                                    @if($key==12)
                                        <tr>
                                            <th style="font-size:large;color: #0e6662 "
                                                class=""> {{trans('lang.specific Setting')}}</th>
                                        </tr>
                                    @endif
                                    <tr>
                                        <th>{{trans('lang.'.$single->name)}}</th>
                                        <td>
                                            <input type="checkbox" value="{{$single->id}}" id="switch{{$key}}"
                                                   switch="purple" name="permissions[]" checked/>
                                            <label for="switch{{$key}}" data-on-label="نعم" data-off-label="لا"
