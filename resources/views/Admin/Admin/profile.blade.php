...
@section('title')
    @if(session('lang') == 'ar')
        الصفحة الشخصية   @else Profile @endif
@endsection
@section('css')
                    ...
                    <form method="post" action="{{url('Update_Profile')}}" enctype="multipart/form-data">
                            ...
                            <div class="col-xl-12">
                                <div class="kt-section__body">
                                    <div class="form-group row">
                                        <label
                                            class="col-xl-3 col-lg-3 col-form-label text-right"> {{trans('lang.Image')}}</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="image-input image-input-empty image-input-outline"
                                                 id="kt_image_1"
                                                 style="background-image: url({{$User->image}}) !important;">
                        ...
                        <i class="ki ki-bold-close icon-xs text-muted"></i>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-solid"  type="text"   style="-webkit-text-security: square;"    value=""
                                               name="password">
                                    </div>
                    ...
                    <form method="post" action="/Store_Setting" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-12">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label">@if(session('lang') == 'ar')
                                            اسم الوزارة التابع لها   @else  Name Arabic @endif</label>
                                    <div class="col-lg-9 col-xl-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label">@if(session('lang') == 'ar')
                                            نوع التاريخ المستخدم      @else  type  @endif</label>
                                    <div class="col-lg-9 col-xl-9">
