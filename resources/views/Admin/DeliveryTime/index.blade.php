                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            <li class="breadcrumb-item">
                                <a href="{{url('Categories')}}" class="text-muted">{{trans('lang.MainCategory')}}</a>
                            </li>
                            @inject('MainCat','App\Models\MainCategory')
                            <li class="breadcrumb-item">
                                <a href="" class="text-muted">{{$MainCat->find($id)->name}}</a>
                            </li>

                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.deliver_time')}}</h5>
                            </li>
                        </ul>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.deliver_time')}}
                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="get" action="{{url('/DeliveryTimeSearch')}}">
                        <div class="col-xl-12">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <input type="hidden" value="{{$id}}" class="form-control form-control-solid"
                                               name="main_category_id" placeholder="{{__('lang.name')}}">
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form" method="post"
                          action="{{url('Create_DeliveryTime')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control form-control-solid" name="main_category_id"
                                   value="{{$id}}" required placeholder="{{__('lang.name_ar')}}">
                        </div>
                        <div class="form-group">
...
@section('js')
    ...
    <script>
        ...
        $(".switchery-demo").click(function () {
            ...
            $.ajax({
                type: "get",
                url: "{{url('UpdateStatusDeliveryTime')}}",
