...
<form class="px-10" novalidate="novalidate" id="kt_form2"  method="post" action='{{url('Update_DeliveryTime')}}' enctype="multipart/form-data">
    <!--begin: Wizard Step 1-->
    @csrf
    <div class="form-group">
        ...
        <input type="hidden" class="form-control form-control-solid"  value="{{$User->main_category_id}}" name="main_category_id" required placeholder="{{__('lang.main_category_id')}}" >
    </div>
    <div class="form-group">
