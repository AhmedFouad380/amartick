                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_tdata">
                        ...
                        <tr>
                            ...
                            <th class="headerr">{{__('lang.estimate_time')}} </th>
                            <th class="headerr">{{__('lang.deliver_time')}} </th>
                        ...
                        @foreach($Users as $Key => $User)
                            <tr>
                                ...
                                <td>{{$User->name_ar}}</td>
                                <td>{{$User->name_en}}</td>
                                <td>{{$User->estimate_time}}</td>
                                <td>
                                    <a class="btn btn-dark  " href="{{url('DeliveryTime/'.$User->id)}}"
                                       data-original-title="{{__('lang.DeliveryTimes')}}"
                                       title="{{__('lang.DeliveryTimes')}}">
                                        <i class="fa fa-list icon-nm"></i>
                                    </a>
                                </td>
                                <td>
                                    <a class="btn btn-primary  " href="{{url('SubCategory/'.$User->id)}}"
                                       data-original-title="{{__('lang.SubCategory')}}"
                        ...
                        <div class="col-xl-12">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="estimate_time"
                                           required placeholder="{{__('lang.estimate_time')}}">
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form" method="post"
                          action="{{url('Create_Categories')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                        ...
                        {{--                            <input type="time" class="form-control form-control-solid" name="deliver_from" required placeholder="{{__('lang.deliver_from')}}" >--}}
                        {{--                        </div>--}}

                        {{--                        <div class="form-group">--}}
                        {{--                            <label>{{__('lang.deliver_to')}} </label>--}}
                        {{--                            <input type="time" class="form-control form-control-solid" name="deliver_to" required placeholder="{{__('lang.deliver_to')}}" >--}}
                        {{--                        </div>--}}

                        <div class="form-group">
                            <label>{{__('lang.estimate_time')}} </label>
                            <input type="text" class="form-control form-control-solid" name="estimate_time" required
                                   placeholder="{{__('lang.estimate_time')}}">
                        </div>
                        <div class="form-group">
                            <label>{{__('lang.supplier_count')}} </label>
                            <input type="number" class="form-control form-control-solid" name="supplier_count" required
                                   placeholder="{{__('lang.estimate_time')}}">
                        </div>
                        <div class="form-group">
                            <label>{{__('lang.max_request')}} </label>
                            <input type="number" class="form-control form-control-solid" name="max_request" required
                                   placeholder="{{__('lang.estimate_time')}}">
                        </div>
                        <div class="form-group">
                            <label>{{__('lang.max_distance')}} </label>
                            <input type="number" class="form-control form-control-solid" name="max_distance" required
                                   placeholder="{{__('lang.estimate_time')}}">
                        </div>
                        <div class="form-group">
                            <label>{{__('lang.max_time_reorder')}} </label>
                            <input type="number" class="form-control form-control-solid" name="max_time_reorder"
                                   required placeholder="{{__('lang.estimate_time')}}">
                        </div>
                        ...
                        <div class="row">
                            ...
                            @for($x = 1; $x < 16 ; $x++)
                                <div class="col-md-3">
                                    <input type="radio" name="icon" value="{{$x.'.png'}}" @if($x==1)checked @endif>
                                    <img src="{{asset('uploads/MainCategory/Icon/'.$x.'.png')}}"
