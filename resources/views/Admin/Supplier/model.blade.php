...
<?php
  if($User->start_job_date){
                    $to_date =   \Carbon\Carbon::parse($User->start_job_date)->format('d-mY-Y');
                $User->start_job_date = $to_date;

        }

          if($User->end_contract_date){

                    $to_date =   \Carbon\Carbon::parse($User->end_contract_date)->format('d-m-Y');
                $User->end_contract_date = $to_date;


        }
        if($User->start_contract_date){

                    $to_date =   \Carbon\Carbon::parse($User->start_contract_date)->format('d-m-Y');
                $User->start_contract_date = $to_date;
        ...
        ?>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-solid"  value="{{$User->name}}"  name="name" required placeholder="{{__('lang.Users_Name')}}" >
                        <input type="hidden" class="form-control form-control-solid"  value="{{$User->id}}"  name="id" required placeholder="" >
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_Nameen')}} </label>
                        <input type="text" class="form-control form-control-solid"  value="{{$User->en_name}}"  name="en_name" required placeholder="{{__('lang.Users_Nameen')}}" >
                    </div>
                      <div class="form-group">
                        <label>{{__('lang.Users_fpuid')}} </label>
                        <input type="number" class="form-control form-control-solid"  value="{{$User->fpuid}}"  name="fpuid" required placeholder="{{__('lang.Users_fpuid')}}" >
                    </div>

                    <div class="form-group">
                        <label>{{__('lang.Users_idnum')}} </label>
                        <input type="number" class="form-control form-control-solid" name="national_id" value="{{$User->national_id}}"  required placeholder="{{__('lang.Users_idnum')}}" >
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_idnum_date')}} </label>
                        <input type="text" class="form-control hijri-date-input " name="date_national_id" value="{{$User->date_national_id}}" required value="">
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_Passport')}} </label>
                        <input type="text" class="form-control form-control-solid" name="passport_id" value="{{$User->passport_id}}" required placeholder="{{__('lang.Users_Passport')}}" >
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_Passport_date')}} </label>
                        <input type="text" class="form-control hijri-date-input" name="date_passport_id" value="{{$User->date_passport_id}}" required value="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-solid" name="converted_num" value="{{$User->converted_num}}"  required placeholder="{{__('lang.Users_Transfer')}}" >
                    </div>
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group">
                                <label>{{__('lang.Users_Mobile')}} </label>
                                <input type="tel" class="form-control form-control-solid" required name="phone"  value="{{$User->phone}}" placeholder="{{__('lang.Users_Mobile')}}" >
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group">
                                <label>{{__('lang.Users_mail')}} </label>
                                <input type="email" class="form-control form-control-solid" required name="email" value="{{$User->email}}" placeholder="{{__('lang.Users_mail')}}" >
                            </div>
                        </div>
                    </div>
                      <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <input class="form-control form-control-solid"  type="text"   style="-webkit-text-security: square;"     name="password" value="">
                                    </div>
                                </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_Birth')}} </label>
                        <input type="text" class="form-control hijri-date-input" name="birth_date"  value="{{$User->birth_date}}" required value="">
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_Address')}}  </label>
                        <input type="text" class="form-control form-control-solid" value="{{$User->address}}"  name="address" required value="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-inline">
                            <label class="radio">
                                <input type="radio" @if($User->type == 1 ) checked @endif name="type" value="1" />
                                <span></span>ذكر</label>
                            <label class="radio">
                                <input type="radio" @if($User->type == 2 ) checked @endif name="type"  value="2" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-inline">
                            <label class="radio">
                                <input type="radio" @if($User->religion == 1 ) checked @endif name="religion" value="1" />
                                <span></span>مسلم</label>
                            <label class="radio">
                                <input type="radio"  @if($User->religion == 2 ) checked @endif  name="religion"  value="2" />
                ...
                <div class="pb-5" data-wizard-type="step-content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-solid"  value="{{$User->job_num}}" name="job_num" placeholder="{{__('lang.Users_Job_number')}}" value="">
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_Dateofhiring')}}</label>
                        <input type="text" class="form-control hijri-date-input" name="start_job_date" value="{{$User->start_job_date}}"  placeholder="{{__('lang.Users_Dateofhiring')}}" >
                    </div>
                    <div class="form-group">
                        <label> {{__('lang.Users_main')}}   </label>
                        @inject('Job','App\Job')
                        <select name="mainJob_id" class="form-control form-control-lg" style="width:100%" id="kt_select5">
                    ...
                    <div class="form-group">
                        ...
                        @inject('Job','App\Job')
                        <select name="subJob_id" class="form-control form-control-lg" style="width:100%"   id="kt_select4">
                            @foreach($Job->all() as $data)
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-solid" value="{{$User->management}}" name="management" placeholder="{{__('lang.Users_Department')}}" >
                    </div>

                    <div class="form-group">
                        <label> {{__('lang.Users_Bonuses')}}   </label>
                        @inject('Bonuses','App\Bonuses')
                        <select name="bonuses_id" class="form-control form-control-lg"  id="kt_select2_1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-solid" name="ipan" value="{{$User->ipan}}" placeholder="{{__('lang.Users_IBAN')}}" >
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_Level')}} </label>
                        <input type="number" class="form-control form-control-solid" name="jobLevel" value="{{$User->jobLevel}}"  placeholder="{{__('lang.Users_Level')}}" >
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_degree')}}  </label>
                        <input type="number" class="form-control form-control-solid" name="jobPercent" value="{{$User->jobPercent}}" placeholder="{{__('lang.Users_degree')}}" >
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_Distinguished')}}   </label>
                        <input type="number" class="form-control form-control-solid" name="badalat" value="{{$User->badalat}}" placeholder="{{__('lang.Users_Distinguished')}}" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-solid"  value="{{$User->comp_insurance_percent}}" name="comp_insurance_percent" placeholder="{{__('lang.Users_percentage')}}" >
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_employee_percentage')}} </label>
                        <input type="number" class="form-control form-control-solid" value="{{$User->emp_insurance_percent}}" name="emp_insurance_percent"  placeholder="{{__('lang.Users_employee_percentage')}}" >
                    </div>
                ...
                <div class="pb-5" data-wizard-type="step-content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-solid" value="{{$User->contract_num}}" name="contract_num" required placeholder="{{__('lang.Users_Contract')}}" value="">
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_Decision')}}</label>
                        <input type="text" class="form-control hijri-date-input" required  value="{{$User->start_contract_date}}" name="start_contract_date" placeholder="{{__('lang.Users_Decision')}}" >
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_point')}}   </label>
                        <input type="text" class="form-control form-control-solid" value="{{$User->decision_point}}" name="decision_point" required placeholder="{{__('lang.Users_point')}}" value="">
                    </div>
                    <div class="form-group">
                        <label>{{__('lang.Users_expiration')}} </label>
                        <input type="text" class="form-control hijri-date-input" required value="{{$User->end_contract_date}}" name="end_contract_date" placeholder="{{__('lang.Users_expiration')}}" >
                    </div>
                    <div class="form-group">
