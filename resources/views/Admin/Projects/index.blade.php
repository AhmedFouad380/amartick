                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            <li class="breadcrumb-item">
                                <a href="{{url('Users')}}" class="text-muted">{{trans('lang.Users')}}</a>
                            </li>
                            @inject('Userr','App\Models\User')
                                                        <li class="breadcrumb-item">
                                                            <a href="" class="text-muted">{{$Userr->find($id) ? $Userr->find($id)->name : "----"}}</a>
                                                        </li>

                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.Projects')}}</h5>
                            </li>
                        </ul>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.Projects')}}
                    </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_tdata">
                        ...
                        <tr>
                            ...
                            <th  class="headerr">{{__('lang.area')}} </th>
                            <th  class="headerr">{{__('lang.description')}} </th>
                            <th  class="headerr">{{__('lang.Wallet')}} </th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($Users as $Key => $User)
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    ...
                                    <a href="{{url('wallet/'.$User->id)}}"  class="btn btn-success btn-sm btn-clean btn-icon btn-icon-md edit-Advert"   >
                                        <i class="fa fa-money-bill icon-nm"></i>
                                    </a>
                                </td>
                            </tr>
                        @endforeach
